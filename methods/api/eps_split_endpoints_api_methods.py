...
def prepare_prescription_prescribing_endpoint(context):
    url = f"{context.eps_fhir_prescribing_base_url}/FHIR/R4/$prepare"
...
def create_signed_prescription_prescribing_endpoint(context):
    url = f"{context.eps_fhir_prescribing_base_url}/FHIR/R4/$process-message#prescription-order"
...
def release_signed_prescription_prescribing_endpoint(context):
    url = f"{context.eps_fhir_prescribing_base_url}/FHIR/R4/Task/$release"
...
def cancel_all_line_items_prescribing_endpoint(context):
    url = f"{context.eps_fhir_prescribing_base_url}/FHIR/R4/$process-message"
...
def dispense_prescription_dispensing_endpoint(context):
    url = f"{context.eps_fhir_dispensing_base_url}/FHIR/R4/$process-message#dispense-notification"
    additional_headers = {"NHSD-Session-URID": CIS2_USERS["dispenser"]["role_id"]}
    headers = get_headers(context, additional_headers)
...
def amend_dispense_notification_dispensing_endpoint(context):
    url = f"{context.eps_fhir_dispensing_base_url}/FHIR/R4/$process-message#dispense-notification"
    additional_headers = {"NHSD-Session-URID": CIS2_USERS["dispenser"]["role_id"]}
    headers = get_headers(context, additional_headers)
...
def withdraw_dispense_notification_dispensing_endpoint(context):
    url = f"{context.eps_fhir_dispensing_base_url}/FHIR/R4/Task"
    additional_headers = {"NHSD-Session-URID": CIS2_USERS["dispenser"]["role_id"]}
    headers = get_headers(context, additional_headers)
...
def return_prescription_dispensing_endpoint(context):
    url = f"{context.eps_fhir_dispensing_base_url}/FHIR/R4/Task"
    additional_headers = {"NHSD-Session-URID": CIS2_USERS["dispenser"]["role_id"]}
    headers = get_headers(context, additional_headers)
