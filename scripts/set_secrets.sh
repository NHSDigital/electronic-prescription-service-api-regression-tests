...
set_environment_secret EPS_FHIR_CLIENT_ID "${INTERNAL_DEV_EPS_FHIR_CLIENT_ID}" RECOVERY
...
set_environment_secret EPS_FHIR_CLIENT_SECRET "${INTERNAL_DEV_EPS_FHIR_CLIENT_SECRET}" RECOVERY
...
set_environment_secret EPS_FHIR_SHA1_CLIENT_ID "${INTERNAL_DEV_EPS_FHIR_SHA1_CLIENT_ID}" RECOVERY
...
set_environment_secret EPS_FHIR_SHA1_CLIENT_SECRET "${INTERNAL_DEV_EPS_FHIR_SHA1_CLIENT_SECRET}" RECOVERY
...
set_environment_secret EPS_FHIR_PRESCRIBING_CLIENT_ID "${INTERNAL_DEV_EPS_FHIR_PRESCRIBING_CLIENT_ID}" RECOVERY
...
set_environment_secret EPS_FHIR_PRESCRIBING_CLIENT_SECRET "${INTERNAL_DEV_EPS_FHIR_PRESCRIBING_CLIENT_SECRET}" RECOVERY
...
set_environment_secret EPS_FHIR_PRESCRIBING_SHA1_CLIENT_ID "${INTERNAL_DEV_EPS_FHIR_PRESCRIBING_SHA1_CLIENT_ID}" RECOVERY
...
set_environment_secret EPS_FHIR_PRESCRIBING_SHA1_CLIENT_SECRET "${INTERNAL_DEV_EPS_FHIR_PRESCRIBING_SHA1_CLIENT_SECRET}" RECOVERY
...
set_environment_secret EPS_FHIR_DISPENSING_CLIENT_ID "${INTERNAL_DEV_EPS_FHIR_DISPENSING_CLIENT_ID}" RECOVERY
...
set_environment_secret EPS_FHIR_DISPENSING_CLIENT_SECRET "${INTERNAL_DEV_EPS_FHIR_DISPENSING_CLIENT_SECRET}" RECOVERY
