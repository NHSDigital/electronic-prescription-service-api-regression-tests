...
set_environment_secret EPS_FHIR_DISPENSING_JWT_CLIENT_ID "${REF_EPS_FHIR_DISPENSING_JWT_CLIENT_ID}" REF
set_environment_secret EPS_FHIR_DISPENSING_JWT_CLIENT_ID "${INTERNAL_DEV_SANDBOX_EPS_FHIR_DISPENSING_JWT_CLIENT_ID}" INTERNAL-DEV-SANDBOX
set_environment_secret EPS_FHIR_DISPENSING_JWT_CLIENT_ID "${INTERNAL_DEV_EPS_FHIR_DISPENSING_JWT_CLIENT_ID}" INTERNAL-DEV
set_environment_secret EPS_FHIR_DISPENSING_JWT_CLIENT_ID "${INT_EPS_FHIR_DISPENSING_JWT_CLIENT_ID}" INT
set_environment_secret EPS_FHIR_DISPENSING_JWT_CLIENT_ID "${INTERNAL_QA_EPS_FHIR_DISPENSING_JWT_CLIENT_ID}" INTERNAL-QA

set_environment_secret EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY "${REF_EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY}" REF
set_environment_secret EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY "${INTERNAL_DEV_SANDBOX_EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY}" INTERNAL-DEV-SANDBOX
set_environment_secret EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY "${INTERNAL_DEV_EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY}" INTERNAL-DEV
set_environment_secret EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY "${INT_EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY}" INT
set_environment_secret EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY "${INTERNAL_QA_EPS_FHIR_DISPENSING_JWT_PRIVATE_KEY}" INTERNAL-QA

set_environment_secret EPS_FHIR_DISPENSING_JWT_KID "${REF_EPS_FHIR_DISPENSING_JWT_KID}" REF
set_environment_secret EPS_FHIR_DISPENSING_JWT_KID "${INTERNAL_DEV_SANDBOX_EPS_FHIR_DISPENSING_JWT_KID}" INTERNAL-DEV-SANDBOX
set_environment_secret EPS_FHIR_DISPENSING_JWT_KID "${INTERNAL_DEV_EPS_FHIR_DISPENSING_JWT_KID}" INTERNAL-DEV
set_environment_secret EPS_FHIR_DISPENSING_JWT_KID "${INT_EPS_FHIR_DISPENSING_JWT_KID}" INT
set_environment_secret EPS_FHIR_DISPENSING_JWT_KID "${INTERNAL_QA_EPS_FHIR_DISPENSING_JWT_KID}" INTERNAL-QA
