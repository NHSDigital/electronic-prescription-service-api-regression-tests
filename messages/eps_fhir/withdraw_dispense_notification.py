...
class WithdrawDispenseNotification:
    def __init__(self, context: Any) -> None:
        ...
        withdraw_dispense_notification = self.withdraw_dispense_notification(
            message_header, medication_dispense, organization
        )

        self.body = json.dumps(withdraw_dispense_notification)

    def practitioner_role(self, ids: WithdrawDispenseNotificationIDs):
        return {
    ...
    def medication_request(self, ids: WithdrawDispenseNotificationIDs, context: Any):
        return {
    ...
    def organization(self, ids: WithdrawDispenseNotificationIDs, context: Any):
        return {
    ...
    def withdraw_dispense_notification(self, *entries):
        return {
            "resourceType": "Bundle",
            "type": "message",
            "entry": entries,
