...
class DispenseNotification:
    def __init__(self, context: Any) -> None:
        ...
        practitioner_role = _practitioner_role(ids)
        medication_request = _medication_request(ids, context)
        medication_dispense = _medication_dispense(
            ids, context, practitioner_role, medication_request
        )

        message_header = _message_header(context)
        organisation = _organisation(ids, context)

        dispense_notification = _dispense_notification(
...
def _practitioner_role(ids: DispenseNotificationIDs):
    return {
...
def _medication_request(ids: DispenseNotificationIDs, context: Any):
    return {
...
def _organisation(ids: DispenseNotificationIDs, context: Any):
    return {
...
def _dispense_notification(*entries):
    return {
        "resourceType": "Bundle",
        "type": "message",
        "entry": entries,
