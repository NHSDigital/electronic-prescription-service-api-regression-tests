...
def login_with_multiple_access_roles(context):
    ...
    ), "Trying to use MOCK_CIS2_LOGIN_ID_MULTIPLE_ACCESS_ROLES in a test not tagged @multiple_access"  # noqa: E501
...
def login_with_no_roles(context):
    ...
    ), "Trying to use MOCK_CIS2_LOGIN_ID_NO_ROLES in a test not tagged @no_roles_no_access"  # noqa: E501
...
def login_with_without_access(context):
    ...
    ), "Trying to use MOCK_CIS2_LOGIN_ID_NO_ACCESS_ROLE in a test not tagged @multiple_roles_no_access"  # noqa: E501
...
def login_with_single_role(context):
    ...
    ), "Trying to use MOCK_CIS2_LOGIN_ID_SINGLE_ACCESS_ROLE in a test not tagged @single_access"  # noqa: E501
